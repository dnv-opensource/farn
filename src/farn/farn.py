...
def run_farn(
    ...
    cases = create_cases(farn_dict, farn_dirs['CASEDIR'])
...
def create_cases(
    ...
    create_cases() creates one distinct case object for each case, holding all case attributes readily parameterized and set to their case specific values.
    ...
    The actual case folders are not yet generated by create_cases().
...
def generate_case_folder_structure(cases: MutableSequence[Case]) -> int:
    ...
    as generated by e.g. create_cases().
...
def generate_case_lists(
    ...
    ----------
    cases : MutableSequence[Case]
        cases the case list files shall be generated for (as generated i.e. by create_cases())
