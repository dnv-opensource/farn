...
def plural(count: int, string: str = "") -> str:
    ...
    ----------
    count : int
        used to determine whether singular or plural form of string shall be returned.
        Could i.e. be length of an iterable. If count > 1, plural form will be returned, else singular.
    string : str, optional
    ...
    mappings = [("", "s"), ("is", "are"), ("was", "were")]  # default / fallback
