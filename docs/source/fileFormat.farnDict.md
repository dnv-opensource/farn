...
| &numsp;&numsp;&numsp;_show                | bool                          | (optional) shows available variables in current level what can be used for (sub-sequent) filtering. |
...
_layers
{
    ...
    cp
    {
        ...
        _condition                              // a condition allows to define a filter expression to include or exclude specific samples.
        {
            ...
            _show    true;                               // (optional) shows available variables in current level what can be used for (sub-sequent) filtering.
        }
    }
    mp
    {
